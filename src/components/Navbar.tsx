  ...
  return (
    <header className="bg-white shadow-md">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-8 py-3">
        <Link
          to="/"
          className="text-2xl font-bold text-[#0A2342] tracking-wide"
        >
          ANCR
        </Link>
        ...
        <nav className="flex flex-wrap gap-2 items-center">
          ...
          <NavLink to="/nuestra-iglesia" className={active}>
            Nuestra Iglesia
          </NavLink>
          <NavLink to="/departamentos" className={active}>
            Departamentos
          </NavLink>
          <NavLink to="/recursos" className={active}>
            Recursos
          </NavLink>
          ...
          <NavLink to="/devocional" className={active}>
            Devocional
          </NavLink>
          ...
          {isLoggedIn && (
            <>
              ...
              <button
                ...
                className="ml-2 px-3 py-2 text-sm rounded-lg border border-gray-300 text-gray-600 hover:bg-gray-100"
              >
                Cerrar sesión
              </button>
            </>
